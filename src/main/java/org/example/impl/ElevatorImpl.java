...
public class ElevatorImpl implements Elevator {
    ...
    public ElevatorImpl(int ID, int capacity, Floor[] allFloors){
        this.ID = ID;
    ...
    public void dropOffPassengers(){
        passengers.removeIf(passenger -> passenger.getDesiredFloor().getID() == currentFloor);
    ...
    public boolean delPassenger(PersonImpl passenger){
